...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("records playres when they enter", async function () {
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, reset the lottery and sends money", async function () {
                  ...
                  const startingAccountIdex = 1 // deployer = 0
                  const accounts = await ethers.getSigners()
                  for (
                      let i = startingAccountIdex;
                      i < startingAccountIdex + additionalEntrants;
                      i++
                  ) {
